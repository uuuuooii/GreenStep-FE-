...
const Explain = () => {
  ...
  // .filter((item) => item.missionId == paramsNum)[0]
      ...
      {!loding ? (
        <div className="detail-wrap-shape">
          <div className="mission-name-and-tag-area">
            <div className="mission-name-text">{select ? select.missionName : 'MissionName'}</div>
          ...
          <img className="mission-image-area" src={select ? select.missionImageUrl : "https://png.pngtree.com/thumb_back/fh260/background/20210207/pngtree-gray-solid-color-simple-background-image_557028.jpg"} />
