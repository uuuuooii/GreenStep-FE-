...
const CameraButton = () => {
  return (
    ...
    >
      <g filter="url(#filter0_d_386_3451)">
        <path
      ...
      <defs>
        ...
        >
          ...
          <feColorMatrix
            type="matrix"
            values="0 0 0 0 0.525 0 0 0 0 0.525 0 0 0 0 0.525 0 0 0 1 0"
          />
          <feBlend
            mode="normal"
            in2="BackgroundImageFix"
            result="effect1_dropShadow_386_3451"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_dropShadow_386_3451"
            result="shape"
          />
        </filter>
      </defs>
