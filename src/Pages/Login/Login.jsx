...
import { LogoFade, FadeBottomOn,FadeBottomOnImage } from '../../Components/Animation/Animation';
  ...
  return (
    <>
      ...
      <FirstArea >
        ...
        <FirstImgDiv >
          <FirstImg src="/images/Login/1번이미지.jpg" animation={firstAni ? FadeBottomOnImage : null} ref={first}/>

          <FirstCoverDiv>
            <FirstCover src="/images/Login/1번커버.png" animation={firstAni ? FadeBottomOn : null}/>{' '}
          </FirstCoverDiv>
        </FirstImgDiv>
        <FirstText animation={firstAni ? FadeBottomOn : null}>{text2}</FirstText>
      </FirstArea>

      <SecondArea  >
        <FirstTitle animation={secondAni ? FadeBottomOn : null} ref={second} >Feed</FirstTitle>
        <SecondImgDiv><SecondImg src="/images/Login/2번이미지.jpg" animation={secondAni ? FadeBottomOnImage : null}  /> 
        <SecondCoverDiv>
            <FirstCover src="/images/Login/2번커버.png" animation={secondAni ? FadeBottomOn : null}  />{' '}
          </SecondCoverDiv>
        </SecondImgDiv>
        <SecondText animation={secondAni ? FadeBottomOn : null} >{text3}</SecondText>
        <SecondRefDiv />
      </SecondArea>
      <FirstArea >
        ...
        <FirstText animation={thirdAni ? FadeBottomOn : null}>{text1}</FirstText>
      </FirstArea>
      <FourthArea>
        <LastTextFirst ref={fourth} animation={fourthAni ? FadeBottomOn : null}>당신이 그릴 스텝,</LastTextFirst>
        <LastTextSecond animation={fourthAni ? FadeBottomOn : null}>"내가 그린 스텝" </LastTextSecond>
        <LastTextThird animation={fourthAni ? FadeBottomOn : null}>지금 시작해볼까요?</LastTextThird>
      </FourthArea>
      <MarginDIv>
